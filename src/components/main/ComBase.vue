      ...
      <el-col :span="4">
        ...
        >
          <el-submenu index="1">
            ...
            <el-menu-item-group>
              <el-menu-item index="1-1">查看简历信息</el-menu-item>
              <el-menu-item index="1-2">已投递简历</el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">
...
export default {
  ...
  mounted () {
    ...
    this.userName = window.sessionStorage.getItem('currentUserName')
  },
  methods: {
    // home返回welcome页面
    goHome () {
    ...
    handleSelectPath (key) {
      switch (key) {
        case '1-1':
          this.$router.push('/ResumeReportPublish')
          break
        case '1-2':
